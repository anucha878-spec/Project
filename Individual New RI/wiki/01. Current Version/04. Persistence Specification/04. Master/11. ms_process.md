...
> **Source:** http://wiki.thaisamut.co.th/display/RDSINRI/11.+ms_process  
> **Page ID:** 1117946417  
> **Path:** Home / Current Version / 04. Persistence Specification / Master / 11. ms_process

---

| **Database** | newri | **Link Previous Version** | - |
| --- | --- | --- | --- |
| **Table** | ms_process | **Data Source** | - |
...
| **Created Date (yyyy-mm-dd )** | 15/12/2023 | **Description** | เก็บข้อมูลรายการ Batch Process |
| **Updated By** |  |  |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | PK | ms_process_id | int8 | default by data type | Y | id ของ Record |  |  |  |  |  |  | 1 |  |  |  |
| 2 |  | process_code | varchar | 20 | Y | รหัสของ Batch Process |  |  |  |  |  |  | RI_AUTO_00RI_FAC_00 |  |  |  |
| 3 |  | process_name | varchar | 255 | Y | ชื่อของ Batch Process |  |  |  |  |  |  | นำเข้าข้อมูลกรมธรรม์ UL (Claim)ค้นหากรมธรรม์ส่งประกันต่อสามัญ (New&Renew) Facultative |  |  |  |
| 4 |  | type | varchar | 1 | Y | ประเภทของ Batch Process (A = Auto, F = Facult, M = Manual) |  |  |  |  |  |  | A = AutoF = FacultM = Manual |  |  |  |
| 5 |  | seq_landing | numeric | 3 | N | ลำดับประมวลผล |  |  |  |  |  |  | 1 |  |  |  |
| 6 |  | status_landing | varchar | 1 | N | สถานะการนำไปเป็นลำดับประมวลผล Auto |  |  |  |  |  |  | A = นำไปเป็นลำดับประมวลผล AutoI = ไม่นำไปเป็นลำดับประมวลผล Auto |  |  |  |
