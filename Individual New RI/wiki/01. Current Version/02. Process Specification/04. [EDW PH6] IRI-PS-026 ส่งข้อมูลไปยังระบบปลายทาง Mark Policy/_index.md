# [EDW PH6] IRI-PS-026 ส่งข้อมูลไปยังระบบปลายทาง Mark Policy

> **Source:** http://wiki.thaisamut.co.th/pages/viewpage.action?pageId=1220739105  
> **Page ID:** 1220739105  
> **Path:** Home / Current Version / 02. Process Specification / [EDW PH6] IRI-PS-026 ส่งข้อมูลไปยังระบบปลายทาง Mark Policy
...
| 3 | เวลาประมวลผล (Time) | Manual : Trigger จากหน้าจอ [10. หน้าจอส่งข้อมูล Mark Policy และ Current NAR](http://wiki.thaisamut.co.th/x/kAF3S)[Auto : เริ่มส่งข้อมูลเมื่อ](http://wiki.thaisamut.co.th/x/kAF3S)[[EDW PH6] IRI-PS-029 ประมวลผล Mark Policy](http://wiki.thaisamut.co.th/x/EwCtSQ) ทำงานเสร็จ (suthanee.sa 11/07/2025 #OIC) |
| 4 | ข้อมูลตั้งต้น(Input) | [tx_ri_mark_policy_hd](http://wiki.thaisamut.co.th/x/BADDS).status = 'SUCCESS' |
| 5 | ข้อมูลที่ได้จากระบบ(Output) | [tx_ri_mark_policy_hd](http://wiki.thaisamut.co.th/x/BADDS),[tx_ri_mark_policy_dt](http://wiki.thaisamut.co.th/x/dAF3S) |
