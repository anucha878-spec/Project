# IRI-PS-010 นำเข้าข้อมูล Rate ทุนประกัน สามัญ

> **Source:** http://wiki.thaisamut.co.th/pages/viewpage.action?pageId=1118929090  
> **Page ID:** 1118929090  
> **Path:** Home / Current Version / 02. Process Specification / IRI-PS-010 นำเข้าข้อมูล Rate ทุนประกัน สามัญ
...
| 5 | ข้อมูลที่ได้จากระบบ(Output) | [WS_RI_14 ดึงข้อมูล Rate ทุนประกัน](/pages/viewpage.action?pageId=1118928904) |
| 6 | อธิบายรายละเอียด(Description) | ดึงข้อมูลจาก [WS_RI_14 ดึงข้อมูล Rate ทุนประกัน](/pages/viewpage.action?pageId=1118928904) ตามรอบประมวลผลกรณีการ Run Process โดยที่ใน [ms_sa_ord_rate](/display/RDSINRI/12.+ms_sa_ord_rate) ยังไม่เคยมีข้อมูลอยู่เลยสร้าง [tx_ri_process_hd](http://wiki.thaisamut.co.th/display/RDSINRI/01.+tx_ri_process_hd)Field NameValueri_process_hd_idauto generateprocess_codeRI_AUTO_10statusSuccess, Errorperiodณ วันที่ batch run (202301)ri_typenullpolicy_typeORDsum_recordจำนวนรวมรายการauto_or_facultnullบันทึกข้อมูลลงที่ [ms_sa_ord_rate](/display/RDSINRI/12.+ms_sa_ord_rate) ดังตารางด้านล่างกรณีการ Run Process โดยที่ใน [ms_sa_ord_rate](/display/RDSINRI/12.+ms_sa_ord_rate) เคยมีข้อมูลอยู่แล้วให้ลบข้อมูลออกทั้ง 2 ตาราง และ insert ใหม่ตามรอบประมวลผล เช่น เมื่อ batch run ใหม่ตามรอบเดือนหรือมีการ กด run manual ที่หน้าจอ (ทั้งกรณี success และซ่อม error)key ในการลบคือ process_codeสร้าง [tx_ri_process_hd](http://wiki.thaisamut.co.th/display/RDSINRI/01.+tx_ri_process_hd)บันทึกข้อมูลลงที่ [ms_sa_ord_rate](/display/RDSINRI/12.+ms_sa_ord_rate) ดังนี้ Service Parameter Landing Table No.Name TypeTableFieldCondition1planCodeVarchar[ms_sa_ord_rate](/display/RDSINRI/12.+ms_sa_ord_rate)plan_code 2saCodenumeric[ms_sa_ord_rate](/display/RDSINRI/12.+ms_sa_ord_rate)sa_code 3saMonthnumeric[ms_sa_ord_rate](/display/RDSINRI/12.+ms_sa_ord_rate)sa_month 4minSanumeric[ms_sa_ord_rate](/display/RDSINRI/12.+ms_sa_ord_rate)min_sa 5maxSanumeric[ms_sa_ord_rate](/display/RDSINRI/12.+ms_sa_ord_rate)max_sa 6saRatenumeric[ms_sa_ord_rate](/display/RDSINRI/12.+ms_sa_ord_rate)sa_rate 7effectiveDatefromdate[ms_sa_ord_rate](/display/RDSINRI/12.+ms_sa_ord_rate)effective_date_from 8effectiveDatetodate[ms_sa_ord_rate](/display/RDSINRI/12.+ms_sa_ord_rate)effective_date_to *หมายเหตุ:* กรณีไม่พบข้อมูล ให้ทำการลบข้อมูลออกทั้ง 2 ตาราง และ insert รายการที่ [tx_ri_process_hd](http://wiki.thaisamut.co.th/display/RDSINRI/01.+tx_ri_process_hd) โดยบันทึก status เป็น success |
| Field Name | Value |
| ri_process_hd_id | auto generate |
| process_code | RI_AUTO_10 |
